/* ================================================================================
   SCRIPT.JS - VERSÃO COM AUTO-SAVE (LOCALSTORAGE)
   ================================================================================ */
...
const STORAGE_KEY = 'ficha_rpg_cyberpunk_auto_save'; // Chave para salvar no navegador
...
function handleSkillChange(el) { 
    ...
    calcularSkills(); 
    salvarAutomaticamente(); // Salva em qualquer mudança
}
...
function confirmarRecorte() { 
    if (cropperInstance) { 
        ...
        cancelarRecorte(); 
        salvarAutomaticamente(); // Salva a imagem
    } 
}
...
// --- HELPERS DE DADOS (GERAR E APLICAR) ---
...
function baixarFicha() {
    ...
    a.download = (dados.nome || "Ficha") + ".json";
...
function carregarFicha(event) {
    ...
    reader.onload = function(e) {
        try {
            ...
            aplicarDadosNaTela(dados);
            salvarAutomaticamente(); // Salva o que acabou de carregar
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Event Listeners para Inputs Gerais (Salvar ao digitar)
